...
TArray<double>& normalize(TArray<double>& v) {
...
Array2D<unsigned> WFC::wave_to_output() const noexcept {
    ...
    output_patterns.complete = true;
    return output_patterns;
}

WFC::WFC(bool periodic_output, int seed,
    TArray<double> patterns_frequencies,
...
WFC::ObserveStatus WFC::observe() noexcept {
    ...
    double random_value = gen.FRandRange(0,s);
        //dis(gen);
